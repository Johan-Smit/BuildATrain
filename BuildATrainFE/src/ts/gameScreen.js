...
function drawTransitions(gridSize) {
    return __awaiter(this, void 0, void 0, function () {
        var y, y, y, x;
        return __generator(this, function (_a) {
...
function drawTracks() {
    return __awaiter(this, void 0, void 0, function () {
        var trackSize, x, x, x, x, x, x, y, y, y, y, y;
        return __generator(this, function (_a) {
            trackSize = 30;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    drawBorder();
                    gridSize = 50;
                    return [4 /*yield*/, drawGrass(gridSize)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, drawSand(gridSize)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, drawTransitions(gridSize)];
                case 3:
                    _a.sent();
